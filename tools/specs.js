...
module.exports = [
{
  ...
  C: 4, R: 3, braid: 0.30, decoys: 2, seed: 11, short: true, wantJunctions: 2,
  decoyPool: ['*m', '*s', '*kg'],
...
},
{
  ...
  C: 5, R: 4, braid: 0.30, decoys: 3, seed: 7, short: true, wantJunctions: 4,
  decoyPool: ['*s', '*kg', '/kg', '*m'],
...
},
{
  ...
  C: 6, R: 5, braid: 0.28, decoys: 5, seed: 3, short: true, wantJunctions: 6,
...
},
{
  ...
  C: 6, R: 5, braid: 0.26, decoys: 6, seed: 5, wantJunctions: 7,
  decoyPool: ['*s', '/kg', '/m', '*m'],
...
},
{
  ...
  C: 6, R: 6, braid: 0.26, decoys: 7, seed: 2, wantJunctions: 8,
  decoyPool: ['*s', '*m', '/m', '*kg'],
...
},
{
  ...
  C: 7, R: 6, braid: 0.24, decoys: 8, seed: 4, wantJunctions: 9,
  decoyPool: ['*m', '*kg', '/kg', '*s'],
...
},
{
  ...
  C: 7, R: 6, braid: 0.24, decoys: 8, seed: 9, wantJunctions: 9,
  decoyPool: ['*m', '*kg', '/s', '*s'],
...
},
{
  ...
  C: 7, R: 6, braid: 0.24, decoys: 8, seed: 6, wantJunctions: 9,
  decoyPool: ['*kg', '/kg', '/m', '*s'],
...
},
{
  ...
  C: 7, R: 6, braid: 0.26, decoys: 8, seed: 8, wantJunctions: 9,
  decoyPool: ['*kg', '/s', '/A', '*m'],
...
},
{
  ...
  C: 8, R: 7, braid: 0.22, decoys: 10, seed: 12, wantJunctions: 11,
  decoyPool: ['*A', '*s', '/m', '*m'],
...
},
{
  ...
  C: 8, R: 7, braid: 0.22, decoys: 10, seed: 13, wantJunctions: 11,
  decoyPool: ['*K', '*kg', '*s', '/s'],
...
},
{
  ...
  C: 8, R: 7, braid: 0.22, decoys: 9, seed: 21, wantJunctions: 11,
  decoyPool: ['*m', '*s', '/m', '*kg'],
...
},
{
  ...
  C: 8, R: 7, braid: 0.22, decoys: 11, seed: 15, wantJunctions: 11,
  decoyPool: ['*kg', '/m', '*s', '/s'],
